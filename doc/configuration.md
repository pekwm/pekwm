...
| FullscreenAbove                | boolean         | Toggles restacking of windows when going to and from fullscreen mode. Windows are restacked to the top of all windows when going to fullscreen and to the top of their layer when being restored from fullscreen. Note that raising a window in this mode will iconify fullscreen windows. |
