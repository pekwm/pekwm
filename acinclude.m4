...
dnl @version $Id: acinclude.m4,v 1.1 2003/08/15 12:22:01 pekdon Exp $

dnl Modified to get rid of the underqouted warning by pekdon
...
size_t iconv();
    ...
    if test "x$am_cv_proto_iconv_arg1" = "xconst"; then
